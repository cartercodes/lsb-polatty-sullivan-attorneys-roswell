    ...
    <>
      ...
      <section className="trust-bar" aria-label="Credentials and trust indicators">
        <div className="trust-bar-inner">
          {[
            ...
            'Exposed to 5,000+ Cases Across Georgia Courts',
            'Top-Rated on Avvo & Google by Roswell Clients',
      ...
      <section className="section services-section" id="services">
        ...
        <div className="services-grid">
          {([
            { title: 'Personal Injury Claims', desc: 'Injured in an accident on GA-400 or anywhere in North Fulton County? Polatty & Sullivan fights aggressively to secure the compensation you deserve — no fee unless we win.' },
            { title: 'Family Law & Divorce', desc: 'Divorce, custody, and support matters handled with discretion and strength. We protect Roswell families through life\'s most difficult transitions with clear strategy and compassionate counsel.' },
            { title: 'Estate Planning & Wills', desc: 'Safeguard your family\'s future with wills, trusts, and powers of attorney tailored to Georgia law. Smart planning today prevents costly disputes tomorrow.' },
            { title: 'Criminal Defense', desc: 'Facing charges in Fulton County or Roswell Municipal Court? Our defense attorneys know the local courts inside and out and will fight to protect your rights and reputation.' },
            { title: 'Business & Commercial Law', desc: 'From formation to contracts to disputes, we help Roswell business owners navigate Georgia\'s legal landscape so they can focus on growth, not litigation.' },
            { title: 'Real Estate & Closings', desc: 'Buying or selling property in Roswell or greater Metro Atlanta? We handle closings, title issues, and disputes to ensure your transaction goes smoothly from contract to keys.' },
      ...
      <section className="section about-section" id="about">
        <div className="about-inner">
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <p>{'Polatty & Sullivan Attorneys has been a trusted legal cornerstone in Roswell, GA for over two decades, representing individuals and families across North Fulton County with tenacity and integrity. From our office in the heart of Historic Roswell, we combine big-firm experience with the personal attention that only a dedicated local practice can deliver. When the stakes are high, Roswell turns to Polatty & Sullivan.'}</p>
        ...
        <div className="footer-inner">
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Business & Commercial Law'}</a></li>
