    ...
    <>
      ...
      <nav className={`nav${navScrolled ? ' scrolled' : ''}`} role="navigation" aria-label="Main navigation">
        <div className="nav-inner">
          <a href="#" className="nav-logo" aria-label="{'Polatty & Sullivan Attorneys'} home">
            {'Polatty & Sullivan Attorneys'}
          </a>
          ...
          <ul className={`nav-links${mobileMenuOpen ? ' mobile-open' : ''}`}>
            ...
            <li>
              <a
                href={'tel:17709923480'}
                className="nav-cta"
                aria-label="Call {'Polatty & Sullivan Attorneys'} at {'+1 770-992-3480'}"
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-badge">
            ...
            Trusted Legal Counsel in {'Roswell'}, {'GA'}
          </div>
          ...
          <p className="hero-subtitle">
            ...
            {'Polatty & Sullivan Attorneys'} provides aggressive, compassionate representation for clients across {'Roswell'} and {'GA'}.
          </p>
          ...
          <div className="hero-actions">
            <a
              ...
              aria-label="Call {'Polatty & Sullivan Attorneys'} for a free consultation"
              style={{ cursor: 'pointer' }}
            >
              <Icon name="phone" className="btn-icon" />
              Free Consultation
      ...
      <section className="trust-bar" aria-label="Credentials and trust indicators">
        <div className="trust-bar-inner">
          {[
            'Serving Roswell & North Fulton for Over 20 Years',
            'Exposed to $50M+ in Recovered Settlements',
            '5-Star Rated on Google by 200+ Clients',
      ...
      <section className="section services-section" id="services">
        ...
        <div className="services-grid">
          {([
            { title: 'Personal Injury Claims', desc: 'Injured in an accident on GA-400 or anywhere in North Fulton County? Polatty & Sullivan fights aggressively to secure the compensation Roswell families deserve — no fee unless we win.' },
            { title: 'Family Law & Divorce', desc: 'Divorce, custody, and support matters handled with discretion and strength. We guide Roswell families through difficult transitions with a strategy built to protect what matters most.' },
            { title: 'Estate Planning & Wills', desc: 'Protect your legacy with wills, trusts, and powers of attorney tailored to Georgia law. Smart estate planning today means peace of mind for your Roswell family tomorrow.' },
            { title: 'Business & Corporate Law', desc: 'From formation to contracts to disputes, we serve Roswell\'s growing business community with practical legal counsel that keeps your company moving forward.' },
            { title: 'Real Estate Transactions', desc: 'Buying or selling property in Roswell or greater Metro Atlanta? Our attorneys handle closings, title issues, and disputes so your investment is protected at every step.' },
            { title: 'Criminal Defense', desc: 'Facing charges in Fulton County? Polatty & Sullivan provides aggressive, discreet criminal defense backed by deep knowledge of local courts and prosecutors.' },
      ...
      <section className="section about-section" id="about">
        <div className="about-inner">
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <h2>Why Choose {'Polatty & Sullivan Attorneys'}</h2>
            <p>{'Polatty & Sullivan Attorneys was founded on a simple principle: Roswell deserves a law firm that treats every client like a neighbor, not a number. Rooted in the North Fulton community, our attorneys combine big-firm experience with the personal attention only a local practice can deliver. Whether you are navigating a family matter, protecting your business, or facing the unexpected, we are the firm Roswell turns to when the stakes are high.'}</p>
      ...
      <section className="testimonials-section" id="testimonials">
        <div className="section-header" data-animate>
          ...
          <p className="section-subtitle">
            Our clients&apos; outcomes speak for themselves. Here&apos;s what people throughout {'Roswell'} have to say about working with our legal team.
          </p>
        </div>
      ...
      <section className="cta-section" data-animate>
        <div className="cta-inner">
          <h2>Contact {'Polatty & Sullivan Attorneys'}</h2>
          <p>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-inner">
          <div className="footer-brand">
            <h3>{'Polatty & Sullivan Attorneys'}</h3>
            <p>
              Providing dedicated legal representation to individuals and families across {'Roswell'}, {'GA'}.
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem' }}>
              ...
              <span>{'965 Canton St, Roswell, GA 30075, USA'}, {'Roswell'}, {'GA'}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Estate Planning & Wills'}</a></li>
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Business & Corporate Law'}</a></li>
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Real Estate Transactions'}</a></li>
          ...
          <div>
            ...
            <ul className="footer-links">
              <li>
                <a href={'tel:17709923480'} style={{ cursor: 'pointer' }}>
                  {'+1 770-992-3480'}
                </a>
              </li>
              <li>{'965 Canton St, Roswell, GA 30075, USA'}</li>
              <li>{'Roswell'}, {'GA'}</li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <span>&copy; {new Date().getFullYear()} {'Polatty & Sullivan Attorneys'}. All rights reserved.</span>
          <span>Serving {'Roswell'}, {'GA'} and surrounding areas</span>
        </div>
      </footer>
    </>
  )
