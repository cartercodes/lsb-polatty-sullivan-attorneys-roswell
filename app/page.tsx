    ...
    <>
      ...
      <section className="trust-bar" aria-label="Credentials and trust indicators">
        <div className="trust-bar-inner">
          {[
            'Serving Roswell & North Fulton Families for Over 20 Years',
            'Exposed to $0 Unless We Recover for You',
            'Rated Among Top Attorneys in Fulton County',
            'Hundreds of Cases Resolved for Local Clients',
          ].map((text, i) => (
      ...
      <section className="section services-section" id="services">
        ...
        <div className="services-grid">
          {([
            { title: 'Personal Injury Claims', desc: 'Injured in an accident on GA-400 or anywhere in North Fulton County? Polatty & Sullivan fights aggressively to secure the compensation you deserve — no fees unless we win.' },
            { title: 'Family Law & Divorce', desc: 'Divorce, custody, and support matters handled with discretion and tenacity. We help Roswell families navigate difficult transitions while protecting what matters most.' },
            { title: 'Criminal Defense', desc: 'Facing charges in Roswell Municipal Court or Fulton County? Our defense attorneys respond fast, build strong cases, and stand with you at every hearing.' },
            { title: 'Estate Planning & Wills', desc: 'Protect your family\'s future with wills, trusts, and powers of attorney tailored to Georgia law. Thoughtful planning today prevents costly disputes tomorrow.' },
            { title: 'Business Litigation', desc: 'From partnership disputes to contract enforcement, we represent Roswell business owners with the same resolve we bring to every case — strategic, thorough, and relentless.' },
            { title: 'Real Estate & Closings', desc: 'Buying or selling property in Roswell or greater North Fulton? We handle closings, title issues, and disputes so your transaction goes smoothly from contract to keys.' },
      ...
      <section className="section about-section" id="about">
        <div className="about-inner">
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <p>{'Polatty & Sullivan Attorneys has been a trusted legal resource in Roswell, GA for over two decades, earning a reputation built on real results and genuine client relationships. From our office in the heart of historic Roswell, we handle complex legal matters with the personal attention of a hometown firm and the courtroom skill of a major practice. When the stakes are high, Roswell turns to Polatty & Sullivan.'}</p>
        ...
        <div className="footer-inner">
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Business Litigation'}</a></li>
